...
harness: claude
skills: [orchestrate, meridian-spawn, meridian-cli, session-mining, meridian-work-coordination, agent-staffing, decision-log, dev-artifacts, dev-principles, shared-workspace]
