...
model: sonnet
effort: high
skills: [agent-management, meridian-spawn, session-mining, meridian-work-coordination, agent-staffing, qi-layer, shared-dao, shared-workspace, intent-modeling, issues, clear-mind]
tools:
  bash: allow
