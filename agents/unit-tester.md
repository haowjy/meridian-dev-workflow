...
Your `unit-test` skill has the methodology. The orchestrator's prompt tells you what to test — specific edge cases, regression guards, or contracts between modules.
