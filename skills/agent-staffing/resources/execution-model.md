...
- **Unclear runtime behavior** → `@prober` probe before re-attempting the fix.
...
`@prober` in probing mode before coding. Don't let @coder guess at system
